...
export const Player = ({name, score, aumentar, disminuir, uid}) => {
    return (
        <div className="card">
            ...
            <div className="buttons">
                <div className="disminuir" onClick={ () => { disminuir(uid) }} >-10</div>
                <div className="aumentar" onClick={ () => { aumentar(uid) }}>+10</div>
            </div>
        </div>
    )
}
